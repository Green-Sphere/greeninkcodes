...
export class RerouteDetailsDialogComponent {
  ...
  constructor(
    ...
    public data: { id: string; subType: string; userId: number },
  ...
  updateReroute() {
    this.saving = true;
    this.supabase
      .updateReroute(this.reroute.id, this.reroute.name, this.reroute.route)
      .then(() => {
  ...
  saveImage() {
    this.qrcode.download(
      ...
      this.reroute.name + '-greenink.png',
    );
  }
